...
START TRANSACTION;
USE `projet_chess`;
INSERT INTO `projet_chess`.`partie` (`id`, `id_joueur1`, `id_joueur2`, `historiquetables`, `statut`, `id_gagnant`, `datedebut`, `datefin`) VALUES (1, -1, 1, NULL, 0, NULL, NULL, NULL);
INSERT INTO `projet_chess`.`partie` (`id`, `id_joueur1`, `id_joueur2`, `historiquetables`, `statut`, `id_gagnant`, `datedebut`, `datefin`) VALUES (2, 1, 2, NULL, 0, NULL, NULL, NULL);
INSERT INTO `projet_chess`.`partie` (`id`, `id_joueur1`, `id_joueur2`, `historiquetables`, `statut`, `id_gagnant`, `datedebut`, `datefin`) VALUES (3, 2, 3, NULL, 0, NULL, NULL, NULL);
INSERT INTO `projet_chess`.`partie` (`id`, `id_joueur1`, `id_joueur2`, `historiquetables`, `statut`, `id_gagnant`, `datedebut`, `datefin`) VALUES (4, 3, -1, NULL, 0, NULL, NULL, NULL);
