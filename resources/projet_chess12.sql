...
START TRANSACTION;
USE `projet_chess`;
INSERT INTO `projet_chess`.`usager` (`id`, `compte`, `motdepasse`, `id_groupeprivileges`, `datecreation`, `courriel`, `sessionid`) VALUES (-1, 'Robot', 'robot', NULL, NULL, 'robot@test.test', NULL);
INSERT INTO `projet_chess`.`usager` (`id`, `compte`, `motdepasse`, `id_groupeprivileges`, `datecreation`, `courriel`, `sessionid`) VALUES (1, 'Gabriel', 'gabriel', NULL, NULL, 'gabriel@test.test', NULL);
INSERT INTO `projet_chess`.`usager` (`id`, `compte`, `motdepasse`, `id_groupeprivileges`, `datecreation`, `courriel`, `sessionid`) VALUES (2, 'Pro', 'pro', NULL, NULL, 'pro@test.test', NULL);
INSERT INTO `projet_chess`.`usager` (`id`, `compte`, `motdepasse`, `id_groupeprivileges`, `datecreation`, `courriel`, `sessionid`) VALUES (3, 'Noob', 'noob', NULL, NULL, 'noob@test.test', NULL);
